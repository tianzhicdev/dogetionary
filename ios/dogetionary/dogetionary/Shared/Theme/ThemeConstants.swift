...
struct AppTheme {
    ...
    /// Pure white - for backgrounds, text on dark backgrounds
    static let white = Color.white

    /// Pure black - for text, shadows, dark elements
    static let black = Color.black

    /// Clear/transparent - for invisible overlays, spacers
    static let clear = Color.clear

    /// Light gray - for subtle borders, disabled states
    static let lightGray = Color.gray.opacity(0.3)

    /// Medium gray - for secondary text, borders
    static let mediumGray = Color.gray.opacity(0.5)

    /// Dark gray - for tertiary text, subtle backgrounds
    static let darkGray = Color.gray.opacity(0.7)

    /// Disabled gray - for disabled button backgrounds
    static let disabledGray = Color.gray.opacity(0.6)

    // MARK: - System Color Aliases (for gradients and theming)
